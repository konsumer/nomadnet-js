...
describe('Packet Encoding/Decoding', () => {
  ...
  test.skip('packetPack and packetUnpack - double header', () => {
    const destHash = new Uint8Array(16).fill(0xaa)
...
describe('Announce', () => {
  test.skip('buildAnnounce and announceParse - no explicit ratchet', () => {
    const identity = identityCreate()
  ...
  test.skip('buildAnnounce with app data', () => {
    const identity = identityCreate()
    const destination = getDestinationHash(identity, 'lxmf.delivery')
...
describe('Data Encryption/Decryption', () => {
  test.skip('buildData and messageDecrypt - basic encryption', () => {
  ...
  test.skip('buildData and messageDecrypt - with ratchet', () => {
    const sender = identityCreate()
    const recipient = identityCreate()
    const recipientDest = getDestinationHash(recipient, 'lxmf.delivery')
    const ratchetPriv = ratchetCreateNew()
...
describe('LXMF higher-level DATA functions', () => {
  test.skip('create a LXMF packet', () => {
...
describe('End-to-End', () => {
  test.skip('complete announce -> data -> proof flow', () => {
    // Setup
